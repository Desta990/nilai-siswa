            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('guru.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nip" id="nip" class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:ring focus:ring-indigo-200" value="{{ old('nip') }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_guru" id="nama_guru" class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:ring focus:ring-indigo-200" value="{{ old('nama_guru') }}" required>
